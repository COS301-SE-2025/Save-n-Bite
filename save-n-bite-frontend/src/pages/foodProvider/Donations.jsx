          ...
          <div className="bg-white rounded-lg shadow-md">
            {filteredDonations.length === 0 ? (
              <div className="p-6 sm:p-8 text-center text-gray-500">
                <Package size={40} className="sm:w-12 sm:h-12 mx-auto mb-4 opacity-50" />
                <p className="text-base sm:text-lg font-medium">No donation requests found</p>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-3">
                          <span className={`inline-flex items-center gap-1 px-2 sm:px-2.5 py-1 rounded-full text-xs font-medium ${getStatusColor(donation.status)}`}>
                        ...
                        {/* NGO Info */}
                        <div className="mb-3">
                          <h3 className="font-semibold text-base sm:text-lg text-gray-900">{donation.user.name}</h3>
                          <p className="text-xs sm:text-sm text-gray-600">{donation.user.email}</p>
                        </div>

                        {/* Items */}
                        <div className="mb-4">
                          <h4 className="font-medium text-gray-900 mb-2 text-sm sm:text-base">Requested Items:</h4>
                        ...
                        {donation.status.toLowerCase() === 'pending' && (
                          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                            <button
                              ...
                              className="flex items-center justify-center gap-2 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                            >
                              <CheckCircle size={16} />
                            ...
                            <button
                              ...
                              disabled={processedDonations.has(donation.id)}
                              className="flex items-center justify-center gap-2 px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                            >
                              <XCircle size={16} />
