    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto transition-colors duration-300">
        <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4 flex justify-between items-center">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Pickup Details</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="text-center border-b border-gray-100 dark:border-gray-700 pb-4">
            <p className="text-sm text-emerald-700 dark:text-emerald-400 mb-1">Pickup Order</p>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mt-2">{order.food_listing?.name}</h3>
                      ...
                      <div className="flex-1 flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className={`text-xs px-2 py-1 rounded-full ${getStatusColor(order)} dark:bg-opacity-80`}>
                              {getStatusText(order)}
                            </span>
                            {order.is_upcoming && (
