...
//     if (isCustomer()) {
//       // Customers only see discount items
//       return listings.filter(listing => listing.type === 'discount');
//     } else if (isNGO()) {
//       // NGOs see both discount and donation items
//       return listings.filter(listing => listing.type === 'discount' || listing.type === 'donation');
//     }
...
//         const userFilteredListings = filterListingsByUserType(allListings);
        
//         setAllFoodListings(allListings);
//         setFilteredListings(userFilteredListings);
//         setTotalCount(userFilteredListings.length); // Use filtered count
//       } else {
...
//   // Update filtered listings when user type changes
//   useEffect(() => {
//     if (allFoodListings.length > 0) {
