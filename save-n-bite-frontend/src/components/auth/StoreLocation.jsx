    ...
    <div className="p-6 border-t border-gray-100">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          className="flex items-center px-4 py-2 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition-colors text-sm"
        >
      ...
      <div className="mb-4 p-3 bg-gray-50 rounded-lg">
        <p className="text-gray-700 font-medium">{businessName || 'Store'}</p>
              ...
              >
                <Popup>
                  <div className="p-2 max-w-xs">
                    <h3 className="font-semibold text-gray-800">{businessName || 'Store'}</h3>
