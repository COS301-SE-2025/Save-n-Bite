    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="p-4 sm:ml-64">
          <div className="p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg mt-14">
      ...
      <div className="p-4 sm:ml-64">
        <div className="p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg mt-14">
          <div className="flex justify-between items-center mb-4">
            <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Your Listings</h1>
            <button
