    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["food_type"], name="food_listin_food_ty_288f00_idx"
                    ),
                    models.Index(
                        fields=["status"], name="food_listin_status_d4fb72_idx"
                    ),
                    models.Index(
                        fields=["expiry_date"], name="food_listin_expiry__40b2c7_idx"
                    ),
                    models.Index(
                        fields=["created_at"], name="food_listin_created_d342ce_idx"
                    ),
                ],
            },
        ),
