# Generated by Django 5.2.6 on 2025-09-06 19:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authentication', '0005_alter_customerprofile_profile_image_and_more'),
        ('food_listings', '0002_foodlisting_admin_flagged_and_more'),
        ('interactions', '0006_rename_interaction_interactionstatushistory_interaction'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('pickup_schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='time_slots', to='scheduling.foodlistingpickupschedule')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('food_listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scheduled_pickups', to='food_listings.foodlisting')),
